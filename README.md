...
## 8. Δομή δεδομένων
     ...
     Αλγόριθμοι :
     File parsing για εξαγωγή στοιχείων προυπολογισμού από PDF
     Από PDF τα δεδομένα μετατρέπονται σε αρχειο CSV, και στη συνέχεια αποθηκεύονται σε βάση δεδομένων μέσω SQLite
     Σειριακή αναζήτηση
     Αλγότιθμοι ελέγχου περιορισμών
