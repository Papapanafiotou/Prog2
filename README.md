...
## 5. Οδηγίες Εκτέλεσης
   Για εκκίνηση του προγράμματος από την γραμμή εντολών: java -cp statewallet.jar mainapp.StateWallet<br />
   Για εκκίνηση του προγράμματος από την γραφική διεπαφή: java -cp statewallet.jar mainapp.StateWalletUI<br />
