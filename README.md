...
* **Λειτουργικότητα:**
    ...
    *   **ΠΡΟΣΘΕΤΕΣ ΛΕΙΤΟΥΡΓΙΕΣ :**
        ...
        * Ανάπτυξη GUI
        * Συγκριση ετών (η συγκεκριμένη λειτουργία υλοποιείται στο branch με όνομα CompareYearsNew)
...
3. Για την εκτέλεση της λειτουργίας του AI σύμβουλου απαιτείται:
    ...
    * Μετονομάστε το αρχείο .env.example σε .env .Στη συνέχεια μέσα σε αυτό το αρχείο, στο σημείο όπου υπάρχει κείμενο, αντιγράψτε το API_KEY σας.
